package kz.meirbek.countryservice.service;

import kz.meirbek.countryservice.dto.Message;
import kz.meirbek.countryservice.entity.Country;
import kz.meirbek.countryservice.repository.CountryRepository;
    ...
    public ResponseEntity<Country> getByAttr(String attr, String value) {
        try {
            ...
            if(attr.equals("id")){
                ...
                country = countryRepository.findCountryByName(value).get();
            }
            else if (attr.equals("isocode")) {
                country = countryRepository.findCountryByIsoCode(value).get();
            }
            else{
                return new ResponseEntity<>(null, HttpStatus.BAD_REQUEST);
            }
