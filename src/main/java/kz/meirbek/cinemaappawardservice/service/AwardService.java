package kz.meirbek.cinemaappawardservice.service;

import kz.meirbek.cinemaappawardservice.dto.Message;
import kz.meirbek.cinemaappawardservice.entity.Award;
import kz.meirbek.cinemaappawardservice.repository.AwardRepository;
    ...
    public ResponseEntity<Award> getByAttr(String attr, String value) {
        try {
            ...
            if(attr.equals("id")){
                ...
                award = awardRepository.getAwardByName(value).get();
            }
            else{
                return new ResponseEntity<>(null, HttpStatus.BAD_REQUEST);
            }
